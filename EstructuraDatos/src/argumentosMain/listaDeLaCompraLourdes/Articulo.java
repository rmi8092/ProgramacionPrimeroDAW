...
public class Articulo {
	 ...
	 */
	void decrementar(int decremento) throws ExistenciasInvalidasException, DecrementoInvalidoException {
		if (decremento < 0)
	...
	private void setExistencias(int existencias)
			throws ExistenciasInvalidasException {
		if (existencias < 0)
			throw new ExistenciasInvalidasException("Las existencias no pueden ser negativas");
