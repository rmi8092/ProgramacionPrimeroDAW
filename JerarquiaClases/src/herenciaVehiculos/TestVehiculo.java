...
public class TestVehiculo {
	...
	private static void repostar() {
		...
		if(catalogoVehiculos.get(vehicu-1).getClass() == Coche.class)
			System.out.println(((Coche)catalogoVehiculos.get(vehicu-1)).accionRepostar(Teclado.leerEntero("Que cantidad quieres repostar?")));
		if(catalogoVehiculos.get(vehicu-1).getClass() == Camion.class)
			System.out.println((((Camion)catalogoVehiculos.get(vehicu-1))).accionRepostar(Teclado.leerEntero("Que cantidad quieres repostar?")));
		if((catalogoVehiculos.get(vehicu-1).getClass() == Bicicleta.class))
			System.out.println((((Bicicleta)catalogoVehiculos.get(vehicu-1))).accionRepostar(Teclado.leerEntero("Que cantidad quieres repostar?")));
		}
